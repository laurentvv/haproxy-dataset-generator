"""
02_ingest_v2.py - Re-chunking intelligent V2 avec enrichissement sémantique
Entrée  : data/sections.jsonl
Sortie  : data/chunks_v2.jsonl

Améliorations V2 :
- Chunking sémantique par concepts HAProxy
...
def main():
    ...
    print(f"\n✅ {len(chunks)} chunks sauvegardés dans {output_path}")
